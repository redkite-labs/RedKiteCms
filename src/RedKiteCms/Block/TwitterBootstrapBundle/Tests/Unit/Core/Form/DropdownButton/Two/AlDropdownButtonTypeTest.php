    ...
    protected function configureFields()
    {
        return array(
            ...
            array(
                'name' => 'button_type',
                'type' => 'choice',
                'options' => array('choices' => array('' => 'base', 'btn-primary' => 'primary', 'btn-info' => 'info', 'btn-success' => 'success', 'btn-warning' => 'warning', 'btn-danger' => 'danger', 'btn-inverse' => 'inverse')),
            ),
            array(
                'name' => 'button_attribute',
                'type' => 'choice',
                'options' => array('choices' => array("" => "normal", "btn-mini" => "mini", "btn-small" => "small", "btn-large" => "large")),
            ),
            array(
                'name' => 'button_block',
                'type' => 'choice',
