...
class AlTemplateGeneratorTest extends Base\AlGeneratorBase
{
    ...
    public function testTemplateConfigurationHasAnyAsset()
    {
        ...
        $expected .= '        <service id="fake_theme.theme.template_assets.home" class="%alpha_lemon_theme_engine.template_assets.class%">' . PHP_EOL;
        $expected .= '        </service>' . PHP_EOL;
        $expected .=  PHP_EOL;
        $expected .= '        <service id="fake_theme.theme.template.home.slots" class="%alpha_lemon_theme_engine.template_slots.class%">' . PHP_EOL;
        $expected .= '            <tag name="fake_theme.theme.template.home" />' . PHP_EOL;
        $expected .= '        </service>' . PHP_EOL;
        $expected .=  PHP_EOL;
        $expected .= '        <service id="fake_theme.theme.template.home" class="%alpha_lemon_theme_engine.template.class%">' . PHP_EOL;
