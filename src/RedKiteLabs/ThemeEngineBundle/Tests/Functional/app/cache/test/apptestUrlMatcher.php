...
class apptestUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // _themes
        if (0 === strpos($pathinfo, '/backend') && preg_match('#^/backend/(?<_locale>[^/]+)/al_showThemes$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'AlphaLemon\\ThemeEngineBundle\\Controller\\ThemesController::showAction',  '_locale' => 'en',)), array('_route' => '_themes'));
        }

        // _activate_theme
        if (0 === strpos($pathinfo, '/backend') && preg_match('#^/backend/(?<_locale>[^/]+)/al_activateTheme/(?<themeName>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'AlphaLemon\\ThemeEngineBundle\\Controller\\ThemesController::activateThemeAction',  '_locale' => 'en',)), array('_route' => '_activate_theme'));
        }
