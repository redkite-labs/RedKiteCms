...
namespace RedKiteLabs\RedKiteCms\RedKiteCmsBaseBlocksBundle\Core\Controller;

use RedKiteLabs\RedKiteCms\RedKiteCmsBaseBlocksBundle\Controller\ElFinderFileController;
...
class ElFinderControllerTest extends CmsElFinderControllerTest
{
    public function testConnectFileAction()
    {
        $container = $this->initContainer(
            ...
            'RedKiteLabs\RedKiteCms\RedKiteCmsBaseBlocksBundle\Core\ElFinder\File\ElFinderFileConnector'
        );
