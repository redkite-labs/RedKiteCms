...
use RedKiteLabs\RedKiteCms\RedKiteCmsBundle\Core\Listener\JsonBlock\RenderingListEditorListener;
...
class RenderingListEditorListenerTest extends BaseTestRenderingEditorListener
{
     ...
     * @expectedExceptionMessage The "configure" method for class "RedKiteLabs\RedKiteCms\RedKiteCmsBundle\Tests\Unit\Core\Listener\JsonBlock\TestRenderingListEditorListener" must return an array
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The array returned by the "configure" method of the class "RedKiteLabs\RedKiteCms\RedKiteCmsBundle\Tests\Unit\Core\Listener\JsonBlock\TestRenderingListEditorListener" method must contain the "blockClass" option
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The block class "Fake" defined in "RedKiteLabs\RedKiteCms\RedKiteCmsBundle\Tests\Unit\Core\Listener\JsonBlock\TestRenderingListEditorListener" does not exists
     */
