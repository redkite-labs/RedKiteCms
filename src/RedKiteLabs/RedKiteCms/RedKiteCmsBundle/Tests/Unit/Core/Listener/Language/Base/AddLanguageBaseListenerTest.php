...
abstract class AddLanguageBaseListenerTest extends BaseListenerTest
{
    ...
    protected function setUp()
    {
        ...
        $this->event = $this->getMockBuilder('RedKiteLabs\RedKiteCms\RedKiteCmsBundle\Core\Event\Content\Language\BeforeAddLanguageCommitEvent')
                                    ->disableOriginalConstructor()
                                    ->getMock();

        $this->languageManager = $this->getMockBuilder('RedKiteLabs\RedKiteCms\RedKiteCmsBundle\Core\Content\Language\AlLanguageManager')
                                    ->disableOriginalConstructor()
                                    ->getMock();
