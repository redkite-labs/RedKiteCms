...
{    
    public function testSlotManagers()
    {
        ...
        {
            $this->assertEquals('The class \Themes\Al2011ThemeBundle\Core\Slots\Al2011ThemeBundleSlots does not exist. You must create a [ThemeName][TemplateName]Slots class for each template of your theme', $ex->getMessage());
        }
        ...
        {
            $this->assertEquals('The class \Themes\Al2011ThemeBundle\Core\Slots\Al2011ThemeBundleFakeSlots does not exist. You must create a [ThemeName][TemplateName]Slots class for each template of your theme', $ex->getMessage());
        }
