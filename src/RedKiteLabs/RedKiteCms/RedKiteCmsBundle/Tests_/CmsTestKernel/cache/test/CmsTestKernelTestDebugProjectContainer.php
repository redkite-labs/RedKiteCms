...
class CmsTestKernelTestDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'al_kernel_exception_listener.class' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AlphaLemon\AlphaLemonCmsBundle\Core\Listener\AlKernelExceptionListener A AlphaLemon\AlphaLemonCmsBundle\Core\Listener\AlKernelExceptionListener instance.
     */
    protected function getAlKernelExceptionListener_ClassService()
    {
        return $this->services['al_kernel_exception_listener.class'] = new \AlphaLemon\AlphaLemonCmsBundle\Core\Listener\AlKernelExceptionListener('security.context', 'security.authentication.trust_resolver');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Component\Filesystem\Filesystem\Filesystem A Symfony\Component\Filesystem\Filesystem\Filesystem instance.
     */
    protected function getFilesystemService()
    {
        return $this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem\Filesystem();
    }
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration(array('datasources' => array('default' => array('adapter' => 'mysql', 'connection' => array('dsn' => 'mysql:host=localhost;dbname=alphalemon_test', 'user' => 'root', 'classname' => 'DebugPDO', 'options' => array(), 'attributes' => array(), 'settings' => array())))));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AlNavigationMenuBundle' => 'AlphaLemon\\AlphaLemonCmsBundle\\Core\\Bundles\\AlNavigationMenuBundle\\AlNavigationMenuBundle',
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/home/giansimon/www/alphaLemon/vendor/bundles/AlphaLemon/AlphaLemonCmsBundle/Resources/config/validation.yml',
            ),
            ...
            'alpalemon.page_tree' => 'AlphaLemon\\PageTreeBundle\\Core\\PageTree\\AlPageTree',
            ...
            'al_kernel_exception_listener.class' => 'AlphaLemon\\AlphaLemonCmsBundle\\Core\\Listener\\AlKernelExceptionListener',
            ...
            'alphalemon.page_tree' => 'AlphaLemon\\AlphaLemonCmsBundle\\Core\\PageTree\\AlPageTree',
            'alphalemon.assets_builder' => 'AlphaLemon\\AlphaLemonCmsBundle\\Core\\AssetsBuilder\\AlAssetsBuilder',
            'alphalemon.links_fixer.class' => 'AlphaLemon\\AlphaLemonCmsBundle\\Core\\LinksFixer\\AlLinksFixer',
