 ...
 */
class AlPageAttributeModel extends Base\AlPropel
{
    public function setModelObject(\BaseObject $object = null)
    {
        if (null !== $object && !$object instanceof AlPageAttribute) {
            throw new General\InvalidParameterTypeException('AlPageAttributeModel accepts only AlPageAttribute propel objects.');
        }
