 ...
 */
class ElFinderStylesheetsConnector extends AlphaLemonElFinderBaseConnector
{
    /**
     * {@inheritdoc}
     */
    protected function configure()
    {
        ...
        $absolutePath = $asset->getAbsolutePath() . '/' . $this->container->getParameter('alpha_lemon_cms.upload_assets_dir') . '/' . $this->container->getParameter('alpha_lemon_cms.deploy_bundle.css_dir') . '/';
        $filesPath = $this->container->getParameter('alpha_lemon_cms.web_folder_full_path') . '/' . $absolutePath;
