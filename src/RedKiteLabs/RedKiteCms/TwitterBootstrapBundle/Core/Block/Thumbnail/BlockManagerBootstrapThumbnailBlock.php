...
namespace RedKiteLabs\RedKiteCms\TwitterBootstrapBundle\Core\Block\Thumbnail;
 ...
 */
class BlockManagerBootstrapThumbnailBlock extends BlockManagerBootstrapSimpleThumbnailBlock
{
    /**
     * Constructor
     *
