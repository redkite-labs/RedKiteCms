...
namespace RedKiteLabs\RedKiteCms\TwitterBootstrapBundle\Core\Form\Factory;
...
class BootstrapFormFactory
{
    ...
    protected function getFormClass($type, $formName)
    {
        ...
        $formClass = sprintf("RedKiteLabs\RedKiteCms\TwitterBootstrapBundle\Core\Form\%s\%s\%s", $type, $bootstrapToken, $formName);
