...
namespace RedKiteLabs\RedKiteCms\TwitterBootstrapBundle\Tests\Unit\Core\Form\Factory;

use RedKiteLabs\RedKiteCms\RedKiteCmsBundle\Tests\TestCase;
use RedKiteLabs\RedKiteCms\TwitterBootstrapBundle\Core\Form\Factory\BootstrapFormFactory;
...
class BootstrapFormFactoryTest extends TestCase
{
    ...
    public function testCreateForm($bootstrapVersion, $bootstrapToken)
    {
        ...
        $className = '\RedKiteLabs\RedKiteCms\TwitterBootstrapBundle\Core\Form\Button\\' . $bootstrapToken . '\ButtonType';
        $this->formFactory
            ->expects($this->once())
            ->method('create')
            ->with(new $className());
