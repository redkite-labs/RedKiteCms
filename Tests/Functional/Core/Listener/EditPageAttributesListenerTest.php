...
use AlphaLemon\AlphaLemonCmsBundle\Core\Listener\Page\AddPageAttributesListener;

class AddPageAttributesListenerTest extends TestCase
{   
    private $event;
    ...
    protected function setUp() 
    {
        ...
        $this->pageAttributes = $this->getMockBuilder('AlphaLemon\AlphaLemonCmsBundle\Core\Content\PageAttributes\AlPageAttributesManager')
        ...
        $this->testListener = new AddPageAttributesListener($this->pageAttributes);
    }
    ...
    public function testSaveFailsWhenAttributesAreNotSaved()
    {
        ...
        $this->pageAttributes->expects($this->once())
            ->method('save')
    ...
    public function testSaveFailsWhenAtLeastAtributeIsNotSaved()
    {
        ...
        $this->pageAttributes->expects($this->exactly(2))
            ->method('save')
