...
use RedKiteCms\Rendering\Controller\Block\RemoveBlockController as BaseBlockController;
use Silex\Application;
use Symfony\Component\HttpFoundation\Request;

/**
 * This object implements the Silex controller to remove a block from page
 *
 * @author  RedKite Labs <webmaster@redkite-labs.com>
 * @package Controller\Block
 */
class RemoveBlockController extends BaseBlockController
{
    /**
     * remove block action
     *
