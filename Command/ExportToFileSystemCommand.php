 ...
 */
class ExportToFileSystemCommand extends ContainerAwareCommand
{
    /**
     * @see Command
     */
    protected function configure()
    {
        $this
            ...
            ->setDefinition(array())
            ->setName('alphalemon:export-to-filesystem');
    ...
    {
        $fsd = new \AlphaLemon\AlphaLemonCmsBundle\Core\Deploy\AlFileSystemDeployer($this->getContainer());
        $fsd->deploy();
    ...
    {
        $fsd = \AlphaLemon\AlphaLemonCmsBundle\Core\Deploy\AlFileSystemDeployer($this->getContainer());
        $fsd->deploy();
        /*
        $container = $this->getContainer();
        $factoryRepository = $container->get('alphalemon_cms.factory_repository');
        $languageRepository = $factoryRepository('Language');
        $pageRepository = $factoryRepository('Page');
